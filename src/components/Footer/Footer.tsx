export default function Footer() {
  return (
    <div className='py-16 bg-natural-100'>
      <div className='max-w-7xl mx-auto px-4'>
        <div className='grid grid-colors-1 lg:grid-cols-3 gap-4'>
          <div className='lg:cols-span-1'>
            <div className='Pc3d01 fPod4n'>© 2024 Shopee. Tất cả các quyền được bảo lưu.</div>
          </div>
